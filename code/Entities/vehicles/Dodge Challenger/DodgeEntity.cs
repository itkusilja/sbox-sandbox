...
public partial class RenaultEntity : Prop, IUse
{
	...
	public override void Spawn()
	{
		...
		var modelName = "models/vehicles/dodge_challenger_2015/dodge_challenger_2015.vmdl";
	...
	public override void ClientSpawn()
	{
...

		{
			...
			chassis_axle_front.LocalPosition = new Vector3( 2.1f, 0, 0.38f ) * 33.0f;
...

		{
			...
			chassis_axle_rear.LocalPosition = new Vector3( -1.9f, 0, 0.38f ) * 33.0f;
