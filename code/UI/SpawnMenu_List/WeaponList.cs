...
public partial class WeaponList : Panel
{
	...
	public bool IsWeapon(Sandbox.LibraryAttribute x)
	{
	...
	public WeaponList()
	{
		...
		Canvas.Layout.ItemSize = new Vector2( 60, 60 );
		...
		var ents = Library.GetAllAttributes<Weapon>().Where( x => IsWeapon(x) ).OrderBy( x => x.Title ).ToArray();
